...
Explanation
    We can swap the a's to b using the 2 swaps and obtain the string "bbbb". This would have all the b's and hence the
    answer 4.Alternatively, we can also swap the b's to make "aaaa". The final answer remains the same for both cases.

 */
public class KartikBhaiyaAndStrings {
    public static int maximumPerfectness(String s,int k,char x){
    ...
    public static void main(String[] args) {
        ...
        int k=sc.nextInt();
        String str=sc.next();
        int maxa=maximumPerfectness(str,k,'b');
        int maxb=maximumPerfectness(str,k,'a');
