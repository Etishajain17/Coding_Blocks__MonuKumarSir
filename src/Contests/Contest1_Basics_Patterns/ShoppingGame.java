...
decides to play a game. Aayush and Harshit decides to shop for smartphones.
...
Explanation
  ...
  Then Aayush shops for 3 smartphones and then Harshit shops for 4 smartphones but that would mean 2 + 4 = 6
  smartphones in total. It's impossible because Harshit can shop for at most N smartphones, so he loses. Aayush wins,
  and so we print "Aayush".
  ...
  which is allowed because it doesn't exceed N). Then Aayush tries to shop for 5 smartphones but he can't
  because 1 + 3 + 5 = 9 which is greater than M. Aayush loses and Harshit is the winner.
 */
...
public class ShoppingGame {
    public static void main(String[] args) {
        ...
        int n=sc.nextInt();
        while(n-->0){
            int a=sc.nextInt(),h=sc.nextInt(),x=0,s=0;
            for(int i=1;i<a;i+=2){
                x+=i;
                if(x>a)
                    break;
